...
<!DOCTYPE html>
	...
	<body>
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-4">
					<form id="frmRegistro">
						<label>Nome</label>
						<input type="text" class="form-control input-sm" name="nome" id="nome"><br>
						<label>Usuário</label>
						...
						<p></p>
						 ...
						 <button span class="btn btn-primary"  id="registro">Salvar</button>
		...
		<!-- Modal --><!--formulário que aparece com as informacoes para serem editadas-->
	...
	<!--PEGA OS DADOS PARA COLOCAR NO MODAL-->
...
//-----------EXCLUIR USUARIO----------------
		function eliminarUsuario(idusuario){
			alertify.confirm('confirmação','Deseja excluir este usuario?', function(){ 
				$.ajax({
					type:"POST",
					data:"idusuario=" + idusuario,
