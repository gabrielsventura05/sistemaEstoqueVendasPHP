...
if(isset($_SESSION['usuario'])){
		...
		$(document).ready(function(){
			...
			$('#btnAdicionarCategoria').click(function(){
				...
				$.ajax({
					type:"POST",
					data:dados,
					url:"../procedimentos/categorias/adicionarCategoria.php",
					success:function(r){
		...
		$(document).ready(function(){
			$('#btnAtualizaCategoria').click(function(){
				...
				$.ajax({
					type:"POST",
					data:dados,
					url:"../procedimentos/categorias/atualizarCategoria.php",
					success:function(r){
						if(r==1){
							$('#tabelaCategoriaLoad').load("categorias/tabelaCategorias.php");
	...
	<script type="text/javascript">
		...
		function eliminaCategoria(idcategoria){
			alertify.confirm('Confirmação', 'Deseja excluir esta categoria?', function(){ 
				$.ajax({
					type:"POST",
					data:"idcategoria=" + idcategoria,
					url:"../procedimentos/categorias/deletarCategoria.php",
					success:function(r){
						if(r==1){
							$('#tabelaCategoriaLoad').load("categorias/tabelaCategorias.php");
