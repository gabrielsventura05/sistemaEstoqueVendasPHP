...
if(isset($_SESSION['usuario'])){
	...
	<body>
		...
		<!-- Modal e a janela que abre com os valores do banco para serem editados--> 
	...
	<script type="text/javascript">
		//essa função pega os dados do cliente para colocar nos campos do modal para edição
		function adicionarDado(idcliente){
			...
			$.ajax({
				...
				success:function(r){
					...
					//os campos vão receber os valores que estão no banco atravéz
					//do proprio nome dos campos
